# Expression 2 - Marble Blast Gold E2
...
**MARBLE BLAST GOLD E2 (requires propcore)**

Wire to a Adv. Pod and a Cam Controller. Make sure you have already spawned a "models/hunter/misc/sphere025x025.mdl" (the small plastic ball). You may only jump when you are on the ground (or 20 units from it). Change InAir to 1 to be able to jump anytime.
