# Expression 2 - Portal song player
...
- Title: Portal song player
- Date (dd-mm-yyyy): 08-01-2013
- Source: https://web.archive.org/web/20150304052417/http://www.wiremod.com/forum/finished-contraptions/31159-portal-song-player.html
...
This is a touchscreen song player that plays portal songs.

Just wire the e2 to an EGP V3 screen and push e on the song you want.

You also need the portal songs to hear it ofcourse.

Im working on a v2 version that looks better and works better and also with only one `if(first())` statement.
