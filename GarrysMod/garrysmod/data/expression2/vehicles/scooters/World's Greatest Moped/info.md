...
further you may run into any other number of issues with hologram spawn rate limits, the server i have on has those disabled so i rarely account for them
