# Expression 2 - Mouse Aimed Bombing Plane
...
### MOUSE AIMED BOMBING PLANE

This E2 sends out a mouse aimed plane that bombs a certain area. `Right click` to launch, `Use key` to freeze in place, type `!remove` to remove the plane an stop the bombing. The plane travels to your cursor's position.
