...
The name was changed due to racism and religion which is banned on this forum. `Reload` to taunt, `right click` to explode. Requires Jihad Bomb addon.
