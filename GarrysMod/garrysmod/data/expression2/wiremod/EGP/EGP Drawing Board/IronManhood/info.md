...
Version 2.3
-Added a lot more hotkeys.
1 through 8 are hotkeys for tools.
Holding shift and pressing minus or equal keys will change certain variables depending on which tool you have selected.

Version 2.2
-Added a drawing tool. Hold the right mouse button and move the cursor to draw.
-Layed the ground work for adding hotkeys.
-Currently, the 1 and 2 keyboard buttons open the box and circle tool respectively.
-The minus and equal keys grow or shrink some shapes.
