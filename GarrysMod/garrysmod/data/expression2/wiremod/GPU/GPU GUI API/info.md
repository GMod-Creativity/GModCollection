...
Notes on optimization : I tried to use data signals to make E2 ops-free, and better coding (dsSendDirect("UpdateText", GGA, array("Button.Play", "Stop"))), but it randomly went into infinite loops of data signals then broke up the E2.
