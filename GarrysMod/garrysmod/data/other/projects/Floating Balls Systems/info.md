# Project - Floating Ball Protection System & Attack of the Balls
...
[YouTube - Garrys Mod - E2 Floating Ball Personal Shield](https://www.youtube.com/watch?v=iMMRIhfptvI)
...
The file attached to this post (floating ball pro.txt) to this folder:
C:\Program Files\Steam\steamapps\<userName>\garrysmod\garrysm od\addons\Adv Duplicator
In-game you should then be able to upload 'floating ball pro.txt' to the server and have fun :) -->

### A Entertaining Similar Contraption

On a side note, here are two really quick entertaining videos of a contraption I made a while ago similar to this contraption. (And similar to some other contraptions posted, but I assure you I did not copy them!)  
[YouTube - Garry's Mod - Attack of the Balls](https://www.youtube.com/watch?v=oSJDqKUaaCI)
