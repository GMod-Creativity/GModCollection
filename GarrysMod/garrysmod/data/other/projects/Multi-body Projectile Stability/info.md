# Project - Multi-body Projectile Stability
...
[YouTube - Multi-body Projectile Stability in Garry's Mod](https://www.youtube.com/watch?v=7RpkkDqbpfU)

### Instructions: 

update code to [this](#re-multi-body-projectile-stability-launcher), adv wire E1 to the red block, E2 to the grey block. Press kp 1 to make the projectile hover, press kp 4 to arm data logging, press kp enter to view cam (kp 2 cycles views). Press kp 0 to launch. Before the projectile hits the ground, press kp 4 to stop data logging. Press kp del to plot data. Press kp 1 to return projectile to launcher hover.
